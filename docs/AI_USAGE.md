...
- Checking for outdated libraries, manual testing.
- Trial and error on models.
- Final project architecture and module boundaries.
- TypeScript implementation and integration of pipeline stages.
- Debugging and manual testing on local machine.
...
- Used Github copilot autocompletion only, to autocomplete function calls, or comments.
- Suggesting prompt wording options for intent detection behavior and drafting some sample prompts.
- The function which calls the Gemini API was written by AI as well as some helper functions only like fixing JSON, cleaning names and phone numbers etc. 
